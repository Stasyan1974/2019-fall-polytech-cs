# arr - список, x - искомый аргумент списка, n - длина arr
def fibsearch(arr, x, n):
  ...
  fib = fib1 + fib2
  # Присвоим переменной fib такое значение, чтобы оно было таким МИНИМАЛЬНЫМ числом, которое БОЛЬШЕ ИЛИ РАВНО n (длина arr)
  while fib < n:
    fib2 = fib1
    fib1 = fib
    fib = fib1 + fib2
